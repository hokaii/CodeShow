...
class HousingAgency:
    ...
    def getMatchInfos(self, searchCondion):
        """根据房源信息的各个属性查找最匹配的信息
        (为节省篇幅这里略去匹配的过程, 全部输出)"""
...
class Customer:
    ...
    def signContract(self, houseInfo, agency, period):
        ...
        print(self.getName(), "与中介", agency.getName(), "签订", houseInfo.getAddress(), "的房子的租赁合同, 租期", period,
              "年. 合同期内", self.__name, "有权对其进行使用! ")
...
if __name__ == '__main__':
    ...
    wangwu.setHouseInfo("金域美和园", 18, 2600, 1, "独立卫生间", 1)
    ...
    tony = Customer("Tony")
    houseInfos = tony.findHouse("18 平方米左右, 要有独立卫生间, 要有窗户, 最好朝南, 有厨房更好! 价位在2000元左右", myHome)
    print()
    print("正在看房, 寻找最合适的住巢...")
    print()
